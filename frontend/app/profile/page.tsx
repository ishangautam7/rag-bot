...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-[#0d0d0d] flex">
            {/* Fixed Sidebar */}
            <div className="fixed top-0 left-0 w-48 h-screen bg-[#141414] border-r border-[#222] flex flex-col text-sm z-40">
                {/* Back Button */}
                <Link
                    href="/chat"
                ...
                <div className="border-t border-[#222] py-2">
                    ...
                    <button
                        onClick={toggleTheme}
                        className="w-full flex items-center justify-between px-3 py-2 text-neutral-400 hover:text-white hover:bg-white/5 transition-colors"
                    >
                        ...
                        <div className={`w-8 h-4 rounded-full relative transition-colors ${theme === 'light' ? 'bg-emerald-500' : 'bg-neutral-700'}`}>
                            <span className={`absolute top-0.5 w-3 h-3 rounded-full bg-white transition-transform ${theme === 'light' ? 'left-4' : 'left-0.5'}`}></span>
                        </div>
                    </button>
                    <button
            ...
            {/* Main Content */}
            <div className="flex-1 p-8 overflow-y-auto ml-48">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4 space-y-4">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        <label className="text-xs text-neutral-500 block mb-1">Username</label>
                                        <input
                                            type="text"
                                            value={user?.username || ''}
                                            disabled
                                            className="w-full bg-[#0d0d0d] border border-[#2a2a2a] rounded px-3 py-2 text-sm text-white disabled:opacity-50"
                                        />
                                    </div>
                                    <div>
                            ...
                            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4 space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <button className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium rounded transition-colors">
                                        Update Password
                                    </button>
                                </div>
                                <p className="text-xs text-neutral-500">Note: Password change is only available for accounts created with email/password.</p>
                            </div>

                            <div className="bg-[#1a1a1a] border border-red-500/30 rounded-lg p-4 space-y-3">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-white text-sm">Delete Account</p>
                                        <p className="text-neutral-500 text-xs">Permanently delete your account and all data</p>
                                    </div>
                                    <button className="px-3 py-1.5 bg-red-500/20 hover:bg-red-500/30 text-red-400 text-sm rounded transition-colors border border-red-500/30">
                                        Delete
                                    </button>
                                </div>
                            </div>

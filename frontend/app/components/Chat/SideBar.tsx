    ...
    <div className="h-full flex flex-col bg-[var(--color-background-secondary)] text-sm border-r border-[var(--color-border)]">
      ...
      <div className="p-2 space-y-2">
        <button
          ...
          className={`w-full bg-black text-white font-medium rounded-lg flex items-center justify-center gap-2 transition-colors hover:bg-[#1A1A1A] ${sidebarOpen ? 'px-3 py-2 text-sm' : 'p-2'}`}
        >
